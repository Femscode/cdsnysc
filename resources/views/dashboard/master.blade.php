...
<head>
  ...
  <title>NYSC-CDS | DASHBOARD</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <meta name="csrf-token" content="{{ csrf_token() }}">
  <link href="assets/img/nysclogo.png" rel="icon">
  <link href="assets/img/nysclogo.png" rel="apple-touch-icon">
...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            @if($user->image !== null)
            <img class="rounded-circle" src="{{ asset('brand_images/'.$user->image.'')}}" alt="Profile Pic">
            @else
      ...
      <div id="navbarVerticalMenuPagesMenu">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
            <i class="bi bi-menu-button-wide"></i><span>CDS Group</span><i class="bi bi-chevron-down ms-auto"></i>
          </a>
          <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li>
              <a href="/notifications">
                <i class="bi bi-circle"></i><span>CDS Group Notifications</span>
              </a>
            </li>
            <li>
              <a href="/cdsprojects">
                <i class="bi bi-circle"></i><span>CDS Group Projects</span>
              </a>
            </li>
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
            <i class="bi bi-award"></i><span>Certificate</span><i class="bi bi-chevron-down ms-auto"></i>
          </a>
          <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li>
              <a href="#">
                <i class="bi bi-circle"></i><span>Print Certificate</span>
              </a>
            </li>
            <li>
              <a href="#">
                <i class="bi bi-circle"></i><span>Verify Certificate</span>
              </a>
            </li>
          </ul>
        </li><!-- End Tables Nav -->
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
            <i class="bi-receipt"></i><span>Payments & Transactions</span><i class="bi bi-chevron-down ms-auto"></i>
          </a>
          <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li>
              <a href="#">
                <i class="bi bi-circle"></i><span>View Pending Payment</span>
              </a>
            </li>
            <li>
              <a href="#">
    ...
    <div class="pagetitle">
      <div class='d-flex'>
        ...
        <div class='col-md-6'>
          ...
          <a href='/excodashboard' class='btn btn-primary m-1'>CDS Exco Dashboard</a>
          @endif
          @if($user->type == 2)

          <a href='/supervisordashboard' class='btn btn-success m-1'>Supervisor Dashboard</a>
          @endif
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Corper's CDS</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
